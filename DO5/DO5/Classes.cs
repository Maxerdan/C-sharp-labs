...
namespace DO5
{
    ...
    public abstract class Therapeutic_Manipulations : Services
    {
    ...
    public abstract class Laboratory_Analysis : Services
    {
    ...
    public abstract class Hospital_Treatment : Services
    {
        public string chosenTypeName;
    ...
    public abstract class Surgical_Manipulation : Services
    {
    ...
    public class Doctors_Appointment : Therapeutic_Manipulations
    {
        // специальность врача
    ...
    public class Ultrasound : Therapeutic_Manipulations
    {
        // узи какого органа
    ...
    public class Haircut : Therapeutic_Manipulations
    {
    ...
    public class Express_Test : Laboratory_Analysis
    {
    ...
    public class Test : Laboratory_Analysis
    {
    ...
    public class Maintenance_In_The_Hospital : Hospital_Treatment
    {
        ...
        public override string ToString()
        {
            return $"Клиника: {Name}, {chosenTypeName}, Время пребывания: {time}, Стоимость: {cost}";
        }
    }

    // производный класс от производного (Обработка ран)
    public class Wound_Treatment : Surgical_Manipulation
    {
    ...
    public class Operation : Surgical_Manipulation
    {
